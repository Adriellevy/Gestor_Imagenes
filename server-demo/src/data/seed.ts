...
const RAW_PEDIDOS_SEED: RawPedidoSeed[] = [
  ...
  { id: uid('ped_'), internacionId: 'i7', servicioSolicitanteId: 'Recuperación cardiovascular', modalidad: 'tc', descripcion: 'Angiotomografía de tórax (protocolo TEP)', tipoTraslado: 'asistido', regionAnatomica: 'Tórax', conContraste: true, prioridad: 'urgente', estado: 'solicitado', motivo: 'TEP', fechaSolicitud: minsAgo(12), emergenciaVista: null },
